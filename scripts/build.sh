...
echo "  3. Local models:     bash scripts/start-inference-server.sh"
echo "  4. ONNX swap:        Set INFERENCE_BACKEND=onnx"
echo "  5. Keras+YOLO swap:  Set INFERENCE_BACKEND=python"
echo "  6. Thesis defense:   See docs/THESIS_VALIDATION.md"
echo ""
